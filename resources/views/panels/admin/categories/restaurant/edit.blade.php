        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('restaurant.update', $restaurantCategory) }}">
                        @csrf
                        @method('PATCH')
                        <div class="py-4">
                            <!--Type-->
                            <div>
                                ...
                                <x-text-input id="type" class="block mt-1 w-full" type="text" name="type" :value="$restaurantCategory->type"  autofocus autocomplete="type" />
